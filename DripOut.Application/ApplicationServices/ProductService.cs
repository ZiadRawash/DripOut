...
namespace DripOut.Application.AuthenticationService
{
	public class ProductService : IProductService
	{
		...
		public ProductService(IBaseRepository<Product> productRepository, ICloudinaryService cloudinaryService, IUnitOfWork unitOfWork)
		{
		...
		public async Task<bool> UpdateProductAsync(int id, ProductInputDTO inputProduct)
		{
