...
namespace DripOut.Persistence.Migrations
{
    ...
    [Migration("20250913032650_ModificationOnOrder")]
    partial class ModificationOnOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DripOut.Domain.Models.Cart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DripOut.Domain.Models.ReviewVote", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DripOut.Domain.Models.Cart", b =>
                {
                    b.HasOne("DripOut.Domain.Models.AppUser", "AppUser")
                        .WithOne("Cart")
                        .HasForeignKey("DripOut.Domain.Models.Cart", "AppUserId")
            ...
            modelBuilder.Entity("DripOut.Domain.Models.CartItem", b =>
                {
                    b.HasOne("DripOut.Domain.Models.Cart", "Cart")
                        .WithMany("CartItems")
            ...
            modelBuilder.Entity("DripOut.Domain.Models.ReviewVote", b =>
                {
                    ...
                    b.HasOne("DripOut.Domain.Models.Review", "Review")
                        .WithMany("ReviewVotes")
